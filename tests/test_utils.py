...
def teardown_function(func):
    """Remove any files created locally during testing."""
    files = os.listdir(".")
    if "downloaded_README.md" in files:
        os.remove("downloaded_README.md")
    if "metadata.tmp" in files:
        os.remove("metadata.tmp")
...
@pytest.mark.parametrize(
    "url",
    [
        "https://gitlab.cern.ch/hep-benchmarks/hep-benchmark-suite/-/raw/qa-v2.0/README.md",
